    ...
    <body data-spy="scroll" data-target="#main-navbar">
		...
		<br>
                ...
                <table>
                    ...
                    <tr>
                        <td style="padding: 0px 0px 10px 30px;">Number of trials :&nbsp;&nbsp;<input type="text" name="Ntrials" value="<?php echo isset($_GET['Ntrials']) ? $_GET['Ntrials'] : 1 ?>"  size="10" maxlength="50"/></td>
                    </tr>
                </table>
